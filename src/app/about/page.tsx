  ...
  return (
    <React.Fragment>
      <section className="mb-20 relative">
        <Back />
        <h1 className="text-3xl mb-6">Namaste</h1>
        <div className="flex flex-col md:flex-row gap-6">
          <div className="w-1/2">
            <p className="mb-5 text-xl! font-medium">
              ...
              software across a variety of settings — from an innovative{" "}
              <Link
            ...
            <p className="my-5 text-xl!">
              ...
              and making them come true is where my passion lies. You can find
          ...
          <div className="w-1/2">
            ...
            <ul className="mt-5 flex gap-2 text-xl!">
              <li>
      ...
      <div className="flex flex-col md:flex-row gap-20 mb-20">
        <section id="testimonials" className="flex-1">
          <h2 className="text-2xl">Kind words from good folks</h2>
          <ul className="list-disc list-inside my-5">
            <li className="mb-1 font-medium">
              Abhin is reliable, with strong ownership and passion. He is calm
              and can work under high pressure with crazy deadlines.
            </li>
            <li className="mb-1">
            ...
            <li>
              He is extremely motivated and has a strong sense of ownership of
              his work.
            </li>
          </ul>
        </section>
        <section id="colophon" className="flex-1">
          <h2 className="text-2xl">This Website</h2>
