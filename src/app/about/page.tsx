  ...
  return (
    <section>
      <h1 className="text-2xl font-bold mb-4 max-w-md">
        <span className="text-neutral-100">Software Engineer</span> with product
      ...
      <p className="mb-4 max-w-md">
        ...
        Artificial Intelligence. I completed a Bachelor of Science in Statistics
        from University of Delhi before this, sharpening my analytical and
        critical skills.
      </p>
      <p className="mb-4 max-w-md">
